...
static const char ImageAnnotateHelp[]=
  ...
  DisplayHelp[]=
    ...
    "            document, you can skip ahead several pages by preceding\0"
    ...
    "\0"
    "            If the image is a multi-paged document such as a Postscript\0"
    "            document, you can skip behind several pages by preceding\0"
    "            this command with a number.  For example to display the\0"
    "            fourth page preceding the current page, press 4space.\0"
    "\0"
